...
def test_gate_fsm_gate_03_logic():
    ...
    passed2, reason2, _results2 = GateFSM.evaluate(state_pass)
    assert passed2
...
def test_event_driven_backtester():
    ...
    OHLCV(Decimal("2500.00"), Decimal("2510.00"), Decimal("2490.00"), Decimal("2500.00"), 10000, datetime.now(timezone.utc), True)
