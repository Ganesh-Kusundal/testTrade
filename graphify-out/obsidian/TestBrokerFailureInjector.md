...
# TestBrokerFailureInjector

## Connections
- [[.test_inject_http_error_after_calls()]] - `method` [EXTRACTED]
- [[.test_inject_rate_limit()]] - `method` [EXTRACTED]
- [[.test_inject_timeout()]] - `method` [EXTRACTED]
- [[.test_inject_token_expiration()]] - `method` [EXTRACTED]
- [[.test_patch_broker_http_context_manager()]] - `method` [EXTRACTED]
...
- [[Test broker API failure injection.]] - `rationale_for` [EXTRACTED]
- [[Tick]] - `uses` [INFERRED]
- [[test_chaos.py]] - `contains` [EXTRACTED]
